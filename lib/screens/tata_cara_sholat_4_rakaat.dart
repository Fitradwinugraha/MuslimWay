...
class TataCaraSholat4Rakaat extends StatelessWidget {
  const TataCaraSholat4Rakaat({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Tata Cara Sholat 4 Rakaat')),
      ...
      body: ListView(
        ...
        children: [
          ...
          buildStep(context, 'assets/images/repeat.png', 
              '9. Ulangi Point 2-7'),
          buildStep(context, 'assets/images/tahiyat_awal.jpg', 
              '10. Tahiyat Awal\nDuduk iftirasy sambil membaca tahiyat awal.'),
          buildStep(context, 'assets/images/berdiri.jpg', 
              '11. Berdiri untuk Rakaat Ketiga\nBerdiri kembali untuk melanjutkan rakaat ketiga.'),
          buildStep(context, 'assets/images/repeat.png', 
              '12. Ulangi Point 2-7'),
          buildStep(context, 'assets/images/berdiri.jpg', 
              '13. Berdiri untuk Rakaat Keempat\nBerdiri kembali untuk melanjutkan rakaat keempat.'),
          buildStep(context, 'assets/images/repeat.png', 
              '14. Ulangi Point 2-7'),
